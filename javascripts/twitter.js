...
function showTwitterFeed(tweets, twitter_user) {
  ...
  for (var t in tweets) {
    content += '<li>'+'<p>'+'<a href="https://twitter.com/'+twitter_user+'/status/'+tweets[t].id_str+'" style="font-size:80%;color:lightslategray">'+prettyDate(tweets[t].created_at)+'</a>&nbsp;&nbsp;'+linkifyTweet(tweets[t].text.replace(/\n/g, '<br>'), tweets[t].entities.urls)+'</p>'+'</li>';
  }
